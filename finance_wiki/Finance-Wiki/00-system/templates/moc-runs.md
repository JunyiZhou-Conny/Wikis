...
regenerate vault notes + pull git.
...
## Done runs — custom metrics

Add columns matching your domain profile (declare north-star in `AGENTS.md`):

```dataview
TABLE status, metrics, tags
FROM "runs"
