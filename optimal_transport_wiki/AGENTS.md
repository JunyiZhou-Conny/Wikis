# AGENTS.md — optimal_transport_wiki

## Project

Hand-curated research brain for optimal transport (OT): Monge/Kantorovich foundations,
entropic/Sinkhorn methods, Wasserstein & Gromov-Wasserstein distances, neural OT, and
**balanced vs unbalanced** optimal transport. Every note is written by you or the agent — no
code engine, nothing auto-generated.

## Vault

- **Obsidian vault root:** `docs/`
- **vault_domain:** `literature-sources` (see `docs/00-system/domains/literature-sources.md`)
- **Sibling wikis:** `../autoencoder_wiki/`, `../finance_wiki/`, `../ml-hardware_wiki/`
