...
This is a **hand-curated research brain** for optimal transport. Notes are written by you and
the agent — there is no code engine and nothing is auto-generated. This file governs *how notes
are shaped* so Obsidian and agents can read them deterministically.
...
| Tier | Bar | Examples |
|---|---|---|
| **A** | Top venue, foundational, or frontier lab | NeurIPS / ICML / ICLR / Nature / Science / top math journals; or the canonical paper for a method |
...
```markdown
## Related
- extends [[2018-chizat-unbalanced-ot-formulations]] — adds fast scaling algorithms on top of the static formulation
- benchmarks [[2013-cuturi-sinkhorn-distances]] — reuses entropic regularization
- contradicts [[some-claim]] — reports the opposite result
```
...
- Domain: `#domain/ml`, `#domain/math`, `#domain/literature`
- Topic: `topic/…` (e.g. `topic/unbalanced-ot`), Method: `method/…`, Field: `field/…`

Don't invent one-off tags. If a tag needs to exist everywhere, add it to this contract.

## Editing discipline

- Source and concept notes are hand-written — edit them freely.
