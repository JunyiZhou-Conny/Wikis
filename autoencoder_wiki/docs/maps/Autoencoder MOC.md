...
- [[2024-templeton-scaling-monosemanticity]] — scales SAEs to Claude 3 Sonnet (up to ~34M features) with compute scaling laws (Transformer Circuits 2024). Tier A.

Concepts: [[sparse-autoencoder-dictionary-learning]] · [[monosemantic-features-vs-polysemantic-neurons]] · [[sae-scaling-laws]]
