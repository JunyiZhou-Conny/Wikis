...
- benchmarks [[2025-gao-scaling-evaluating-saes]] — probe recovery, N2G explainability, and ablation sparsity as scale-up tests of feature quality
- applies [[sparse-autoencoder-dictionary-learning]] — the decomposition method that targets this distinction
- applies [[topk-k-sparse-autoencoder]] — TopK clamping of small activations as one route to cleaner random-activating examples
